...
namespace Api.Data
{
    public static class SeedData
    {
        public static void Seed(ModelBuilder builder)
        {
            ...
            {
                new BidEntity { Id=1,HouseId=1,Bidder="Subin"},
                new BidEntity { Id=2,HouseId=2,Bidder="Nibin"},
                new BidEntity { Id=3,HouseId=1,Bidder="Subin"},
                new BidEntity { Id=4,HouseId=2,Bidder="Nibin"}
            });
        }
    }
}
